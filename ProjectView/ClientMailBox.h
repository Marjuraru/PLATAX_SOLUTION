...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button_cleanformessage->Text = L"No adjuntar vehículo";
			...
			this->button_reply_message->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button_reply_message->Location = System::Drawing::Point(1001, 577);
			...
			this->button_showvehicle->Location = System::Drawing::Point(771, 569);
			...
			this->textBox_showsbuject->Location = System::Drawing::Point(944, 116);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(808, 118);
			...
			this->textBox_showname->Location = System::Drawing::Point(944, 78);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->Location = System::Drawing::Point(808, 82);
			...
			this->textBox_from->Location = System::Drawing::Point(944, 40);
			...
			this->label_from_to->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label_from_to->Location = System::Drawing::Point(808, 42);
			...
			this->richTextBox_showmessage->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->richTextBox_showmessage->Location = System::Drawing::Point(771, 170);
...
#pragma endregion
	...
	private: System::Void button_send_message_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (Confirmarexistencia()) {
			...
			if (comboBox2->Text != "30 días") {
				mail->DaysAgreed = 30;
			}
			else {
				if (comboBox2->Text != "60 días") {
					mail->DaysAgreed = 60;
				}
				else {
					if (comboBox2->Text != "90 días") {
						mail->DaysAgreed = 90;
					}
					else {
						mail->DaysAgreed = 0;
...
private: System::Void button_reply_message_Click(System::Object^ sender, System::EventArgs^ e){
	...
	if (mailselected != nullptr){
		if (mailselected->MailSelected){
			...
			if (mailselected->vehicle != nullptr){
