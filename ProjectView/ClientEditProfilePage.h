...
namespace ProjectView {
	...
	/// </summary>
	public ref class ClientEditProfilePage : public System::Windows::Forms::Form
	{
	public:
		ClientEditProfilePage(void)
		{
			InitializeComponent();
			//
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->checkBox_male->CheckedChanged += gcnew System::EventHandler(this, &ClientEditProfilePage::checkBox_male_CheckedChanged);
			// 
			// checkBox_female
			// 
			...
			this->checkBox_female->CheckedChanged += gcnew System::EventHandler(this, &ClientEditProfilePage::checkBox_female_CheckedChanged);
			// 
			// textBox_address
			// 
			...
			this->button_savechanges->Click += gcnew System::EventHandler(this, &ClientEditProfilePage::button_savechanges_Click);
			// 
			// label9
			// 
			...
			this->label1->Size = System::Drawing::Size(362, 38);
			this->label1->TabIndex = 28;
			this->label1->Text = L"PERFIL DE CLIENTE";
			// 
			// pb_photo
			// 
			...
			this->button_insertphoto->Click += gcnew System::EventHandler(this, &ClientEditProfilePage::button_insertphoto_Click);
			// 
			// textBox_newpassword
			// 
			...
			this->button_back->Click += gcnew System::EventHandler(this, &ClientEditProfilePage::button_back_Click_1);
			// 
			// ClientEditProfilePage
			// 
